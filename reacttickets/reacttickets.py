...
class ReactTickets(commands.Cog):
    ...
    async def ticketset_start(self, ctx: commands.Context):
        ...
        description = self._get_cases_string(
            cases, "React to this message using the emojis below to open a ticket.\n"
        )
        ...
        embed.set_image(url="https://i.imgur.com/xxDZkpJ.gif")
        embed.set_thumbnail(url="https://cdn.discordapp.com/attachments/978078455629500456/991881239118237766/discord_avi.gif")
